...
class AutoOrderReminder(object):
    ...
    def update_proxies(self, num):
        ...
        # 直连IP
        # url = 'http://webapi.http.zhimacangku.com/getip?num={0}&type=2&pro=&city=0&yys=0&port=11&pack=110169&ts=1&ys=0&cs=1&lb=1&sb=0&pb=4&mr=1&regions='
        # 隧道IP
        url = 'http://http.tiqu.alicdns.com/getip3?num={0}&type=2&pro=&city=0&yys=0&port=11&pack=110169&ts=1&ys=0&cs=1&lb=1&sb=0&pb=4&mr=1&regions='
        # 独享IP
