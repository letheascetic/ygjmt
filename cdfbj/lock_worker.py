...
class LockWorker(threading.Thread):
    ...
    def __init__(self, id, goods_user_info, user_info_list):
    ...
    def run(self):
        ...
        while self.m_running:
            ...
            logger.info('thread[{0}] [{1}], start [{2}] times, [{3}] goods to lock............................................'.format(self.id, current_time, i, len(goods_ids)))
            ...
            for goods_id in goods_ids:
                ...
                lock_users = []
                for user in users:
                    if self.user_info_list[user]['goods'][goods_id] < stock:
                        lock_users.append(user)
